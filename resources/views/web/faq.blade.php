...
<!--Page Title-->
<!--<section class="page-title" style="background-image:url(/public/images/background/bg1.png);">-->
<!--    <div class="auto-container">-->
<!--        <h1 style="color: #F5A01C;">FAQ's</h1>-->
...
<!--    </div>-->
<!--</section>-->
<section class="page-title" style="position: relative; background-image: url(/public/images/background/9.jpeg); background-size: cover; background-position: center;">
                    ...
                    <ul class="accordion-box">
                        ...
                        <li class="accordion block active-block wow fadeInUp">
                            ...
                            <div class="acc-content current">
                                <div class="content">
                                    <div class="text">The summit will take place on June 19th and 20th, 2025, from 9:00 AM to 4:00 PM at the Marriott Hotel, Lagos, Nigeria.
The hotel is strategically located in the heart of Ikeja, the capital of Nigeria’s commercial city — Lagos. It is just a 10-minute drive from the Lagos Domestic and International Airports and is surrounded by shops, restaurants, and bars.

For more information, you can contact the Event Coordinator at
 <a href="tel:+2347056592645">+234 705 659 2645</a> or
 <a href="mailto:events@rtmwestafrica.com">events@rtmwestafrica.com</a></div>
                                </div>
                            </div>
                        </li>
...
<section class="faq-form-section">
    <div class="auto-container">
        ...
        <!-- Faq Form -->
        <div class="faq-form">
            <form method="POST" action="{{ route('contact') }}" id="contactForm" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="form-group col-lg-12 col-md-12 text-right">
                        <button class="theme-btn btn-style-three" type="submit"><span class="btn-title">Submit</span></button>
                    </div>
                </div>
            </form>

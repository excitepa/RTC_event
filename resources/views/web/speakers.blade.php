...
<section class="speakers-section-two">
    ...
    <div class="auto-container">
        ...
        <div class="row">
            ...
            <div class="speaker-block-two col-xl-3 col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                <div class="inner-box">
                    ...
                    <div class="image-box">
                        <figure class="image"><a href="speakers-detail.html"><img src="images/speaker-1.jpg" alt=""></a></figure>
                    </div>
        ...
        <div class="row">
            <!-- Speaker Block -->
            <div class="speaker-block-two col-xl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp">
                <div class="inner-box">
                    <div class="info-box">
        ...
        <div class="auto-container">
            ...
            <div class="row">
                ...
                <div class="speaker-block-three col-xl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><a href="https://www.linkedin.com/in/adebola-afolabi/"><img src="/public/images/background/afolabi.png" alt=""></a></figure>
                        </div>
                        <div class="info-box">
                            <h4 class="name"><a href="https://www.linkedin.com/in/adebola-afolabi/">Adebola Afolabi</a></h4>
                            <span class="designation">Chief Technology Officer</span>
                            <span class="designation">Soft Thread Solution</span>
                        </div>
                        <div class="social-box">
                            <ul class="social-links social-icon-colored">
                                <li><a href="https://www.linkedin.com/in/adebola-afolabi/"><i class="fab fa-linkedin"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="sec-title text-center">
                ...
                <div class="row">
                    ...
                    <div class="speaker-block-three col-xl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="https://www.linkedin.com/in/peter-research/"><img src="/public/images/background/mokofe.png" alt=""></a></figure>
                            </div>
                            <div class="info-box">
                    ...
                    <div class="speaker-block-three col-xl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="https://www.linkedin.com/in/adebola-arotiowa-a67aa1196/"><img src="/public/images/background/mokofe.png" alt=""></a></figure>
                            </div>
                            <div class="info-box">
                    ...
                    <div class="speaker-block-three col-xl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="https://www.linkedin.com/in/godson-nkeokelonye-3b444922/"><img src="/public/images/background/mokofe.png" alt=""></a></figure>
                            </div>
                            <div class="info-box">

        ...
        <div class="auto-container">
            <div class="sec-title text-center">
                ...
                <div class="row">
                    ...
                    <!-- Speaker Block -->
                    <div class="speaker-block-three col-xl-4 col-lg-4 col-md-12 col-sm-12 wow fadeInUp">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="https://www.linkedin.com/in/farouk-gumel-736a12200/"><img src="/public/images/background/farouk.jpeg" alt=""></a></figure>
                            </div>
                            <div class="info-box">
                                <h4 class="name"><a href="https://www.linkedin.com/in/farouk-gumel-736a12200/">Farouk Gumel</a></h4>
                                <span class="designation">Vice Chairman</span>
                                <span class="designation">Tropical General Investments (TGI) Group</span>
                            </div>
                            <div class="social-box">
                                <ul class="social-links social-icon-colored">
                                    <li><a href="https://www.linkedin.com/in/farouk-gumel-736a12200/"><i class="fab fa-linkedin"></i></a></li>
                                    {{-- <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href="#"><i class="fab fa-pinterest"></i></a></li>
                                    <li><a href="#"><i class="fab fa-dribbble"></i></a></li> --}}
                    ...
                    <div class="speaker-block-three col-xl-4 col-lg-4 col-md-12 col-sm-12 wow fadeInUp">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="https://www.linkedin.com/in/russomr/"><img src="/public/images/background/mario.jpeg" alt=""></a></figure>
                            </div>
                            <div class="info-box">
                                <h4 class="name"><a href="https://www.linkedin.com/in/russomr/">Mario Russo</a></h4>
                                <span class="designation">Managing Director</span>
                                <span class="designation">BRALICO</span>
                            </div>
                            <div class="social-box">
                                <ul class="social-links social-icon-colored">
                                    <li><a href="https://www.linkedin.com/in/russomr/"><i class="fab fa-linkedin"></i></a></li>
                                    {{-- <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href="#"><i class="fab fa-pinterest"></i></a></li>
                                    <li><a href="#"><i class="fab fa-dribbble"></i></a></li> --}}
                    ...
                    <div class="speaker-block-three col-xl-4 col-lg-4 col-md-12 col-sm-12 wow fadeInUp">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="https://www.linkedin.com/in/lioparent/"><img src="/public/images/background/lionel.jpeg" alt=""></a></figure>
                            </div>
                            <div class="info-box">
                                <h4 class="name"><a href="https://www.linkedin.com/in/lioparent/">Lionel Parent</a></h4>
                                <span class="designation">Regional Managing Director</span>
                                <span class="designation">Danone</span>
                            </div>
                            <div class="social-box">
                                <ul class="social-links social-icon-colored">
                                    <li><a href="https://www.linkedin.com/in/lioparent/"><i class="fab fa-linkedin"></i></a></li>
                                    {{-- <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href="#"><i class="fab fa-pinterest"></i></a></li>
                                    <li><a href="#"><i class="fab fa-dribbble"></i></a></li> --}}
                ...
                <div class="row">
                    ...
                    <div class="speaker-block-three col-xl-4 col-lg-4 col-md-12 col-sm-12 wow fadeInUp">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="https://www.linkedin.com/in/akilahyel-malgwi-8ba93336/"><img src="/public/images/background/malgwi.jpeg" alt=""></a></figure>
                            </div>
                            <div class="info-box">
                                <h4 class="name"><a href="https://www.linkedin.com/in/akilahyel-malgwi-8ba93336/">Akilahyel Malgwi</a></h4>
                                <span class="designation">Commercial Director</span>
                                <span class="designation">Kerry</span>
                            </div>
                            <div class="social-box">
                                <ul class="social-links social-icon-colored">
                                    <li><a href="https://www.linkedin.com/in/akilahyel-malgwi-8ba93336/"><i class="fab fa-linkedin"></i></a></li>
                                    {{-- <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href="#"><i class="fab fa-pinterest"></i></a></li>
                                    <li><a href="#"><i class="fab fa-dribbble"></i></a></li> --}}
                    ...
                    <div class="speaker-block-three col-xl-4 col-lg-4 col-md-12 col-sm-12 wow fadeInUp">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="https://www.linkedin.com/in/oghale-elueni-72203243/"><img src="/public/images/background/oghale.jpeg" alt=""></a></figure>
                            </div>
                            <div class="info-box">
                                <h4 class="name"><a href="https://www.linkedin.com/in/oghale-elueni-72203243/">Oghale Elueni</a></h4>
                                <span class="designation">Managing Director, Africa</span>
                                <span class="designation">PZ Cussons</span>
                            </div>
                            <div class="social-box">
                                <ul class="social-links social-icon-colored">
                    ...
                    <div class="speaker-block-three col-xl-4 col-lg-4 col-md-12 col-sm-12 wow fadeInUp">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="https://www.linkedin.com/in/alistair-gordon-1723441/"><img src="/public/images/background/gordon.jpeg" alt=""></a></figure>
                            </div>
                            <div class="info-box">
                                <h4 class="name"><a href="https://www.linkedin.com/in/alistair-gordon-1723441/">Alistair Gordon</a></h4>
                                <span class="designation">CEO</span>
                                <span class="designation">Lumos</span>
                            </div>
                            <div class="social-box">
                                <ul class="social-links social-icon-colored">
                                    <li><a href="https://www.linkedin.com/in/alistair-gordon-1723441/"><i class="fab fa-linkedin"></i></a></li>
                                    {{-- <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href="#"><i class="fab fa-pinterest"></i></a></li>
                                    <li><a href="#"><i class="fab fa-dribbble"></i></a></li> --}}
                ...
                <div class="row">
                    ...
                    <div class="speaker-block-three col-xl-6 col-lg-6 col-md-6 col-sm-12 wow fadeInUp">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="https://www.linkedin.com/in/emmanuel-edi-bala-88a40410/"><img src="/public/images/background/edi-bala.jpeg" alt=""></a></figure>
                            </div>
                            <div class="info-box">
                                <h4 class="name"><a href="https://www.linkedin.com/in/emmanuel-edi-bala-88a40410/">Emmanuel Edi-Bala</a></h4>
                                <span class="designation">Commercial Director</span>
                                <span class="designation">Twinings</span>
                            </div>
                            <div class="social-box">
                                <ul class="social-links social-icon-colored">
                                    <li><a href="https://www.linkedin.com/in/emmanuel-edi-bala-88a40410/"><i class="fab fa-linkedin"></i></a></li>
                                    {{-- <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href="#"><i class="fab fa-pinterest"></i></a></li>
                                    <li><a href="#"><i class="fab fa-dribbble"></i></a></li> --}}
                    ...
                    <div class="speaker-block-three col-xl-6 col-lg-6 col-md-6 col-sm-12 wow fadeInUp">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="https://www.linkedin.com/in/topeayedun/"><img src="/public/images/background/tope.jpeg" alt=""></a></figure>
                            </div>
                            <div class="info-box">
                                <h4 class="name"><a href="https://www.linkedin.com/in/topeayedun/">Ayedun Tope</a></h4>
                                <span class="designation">Managing Director</span>
                                <span class="designation">Planet Talk</span>
                            </div>
                            <div class="social-box">
                                <ul class="social-links social-icon-colored">
                                    <li><a href="https://www.linkedin.com/in/topeayedun/"><i class="fab fa-linkedin"></i></a></li>
                                    {{-- <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href="#"><i class="fab fa-pinterest"></i></a></li>
                                    <li><a href="#"><i class="fab fa-dribbble"></i></a></li> --}}
                    ...
                    <!--    <div class="inner-box">-->
                    <!--        <div class="image-box">-->
                    <!--            <figure class="image"><a href="https://www.linkedin.com/in/anthonilious-okojie-91654a13/"><img src="/public/images/background/malgwi.jpeg" alt=""></a></figure>-->
                    <!--        </div>-->
                    <!--        <div class="info-box">-->
                    <!--            <h4 class="name"><a href="https://www.linkedin.com/in/anthonilious-okojie-91654a13/">Akilahyel Malgwi</a></h4>-->
                    <!--            <span class="designation">Commercial Director</span>-->
                    <!--            <span class="designation">Kerry</span>-->
                    <!--        </div>-->
                    <!--        <div class="social-box">-->

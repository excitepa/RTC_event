...
@section('content')
    ...
    <section class="error-section" style="padding-top: 50px;">
        ...
        <div class="auto-container">
            ...
            <h2>Thank You for Confirming Your Delegate Attendance!</h2>
            {{-- <div class="text">We appreciate your interest in <strong>Building a Consumer-
                Centric Route-to-Market</strong></div> --}}
            <div class="text" style="font-size: 20px;">Keep an eye on your inbox — important updates and exciting details are on the way.</div>
            <div class="text" style="font-size: 20px;">We look forward to an engaging, insightful, and impactful experience together!</div>

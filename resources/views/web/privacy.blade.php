...
<section class="event-detail">
    <div class="auto-container">
        ...
        <div class="content-box">
            ...
            <h2>2. Users may, however, visit our Site anonymously</h2>
            ...
            <p>Route to Market West Africa collects and uses Users personal information for the following purposes: </p>
            ...
            <h5>To administer a content, promotion, survey or other Site feature </h5>
            ...
            <p>Users may choose to delete their accounts when our services are no longer required. The option to delete user account is resident in the account menu under account settings. </p>

            <h2>6. Third party websites  </h2>
            <p>Users may find advertising or other content on our Site that link to the sites and services of our partners, Vendors, advertisers, sponsors, licensors and other third parties. We do not control the content or links that appear on these sites and are not responsible for the practices employed by websites linked to or from our Site. In addition, these sites or services, including their content and links, may be constantly changing. These sites and services may have their own privacy policies and customer service policies. Browsing and interaction on any other website, including websites which have a link to our Site, is subject to that website\'s own terms and policies. </p>

            <h2>7. Changes to this privacy policy   </h2>
            <p>Route to Market West Africa has the discretion to update this privacy policy at any time. When we do, we will post a notification on the main page of our Site, revise the updated date at the bottom of this page, send you an email. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications. </p>

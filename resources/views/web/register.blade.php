...
<head>
<meta charset="utf-8">
<title>{{ env('APP_NAME') }} - Register for Route to Market West Africa 2025</title>
...
<div class="page-wrapper">
    ...
    <!--End Page Title-->
    <section class="page-title" style="position: relative; background-image: url(images/background/5.jpeg); background-size: cover; background-position: center;">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                        <select class="form-select" name="country" aria-label="Select your country" required>
                                            <option value="" disabled selected>Choose your country (optional)</option>

        ...
        <div class="row justify-content-center">
         ...
         <div class="auto-container">
            ...
            <p style="font-size: 16px; color: #666;">
                Please note: All registrations are subject to review and confirmation.
            </p>
            <div class="text" style="font-size: 20px;">Stay close to your inbox — we’ll be sharing important updates soon</div>

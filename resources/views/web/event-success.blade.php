...
<head>
<meta charset="utf-8">
<title>{{ env('APP_NAME') }} - Registered</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <section class="error-section" style="padding-top: 50px;">
        ...
        <div class="auto-container">
            ...
            {{-- <div class="text">We appreciate your interest in <strong>Building a Consumer-
                Centric Route-to-Market</strong></div> --}}
            <div class="text" style="font-size: 20px;">Stay close to your inbox — we’ll be sharing important updates soon including event details, speakers, discussion topics and more</div>
            <div class="text" style="font-size: 20px;">We look forward to an insightful and impactful experience together!</div>
            <a href="{{ route('index') }}" class="theme-btn btn-style-three"><span class="btn-title">Home Page</span></a>
            <a href="{{ route('faq') }}" class="theme-btn btn-style-two"><span class="btn-title">Contact Us</span></a>
        </div>
    </section>
    <!--Error Section-->

...
@section("page_title", "Delegate for Route to Market West Africa 2026")
@section('content')
                ...
                <div class="form-column col-lg-8 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="contact-form">
                            <div class="sec-title">
                                <h2>Delegate Attendance Confirmation</h2>
                            </div>
                            <form method="POST" action="{{ route('delegate.submit') }}" id="delegateForm" enctype="multipart/form-data">
                                @csrf
                                <div class="row clearfix">

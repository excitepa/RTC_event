                ...
                <div class="news-block col-lg-12 col-md-12 col-sm-12 wow fadeInRight">
                    ...
                    <div class="inner-box">
                        ...
                        <div class="lower-content">
                            ...
                            <h4><a href="#">MARGINS OF TRUST - THE INFORMAL ECONOMY, INCLUSION AND THE FUTURE OF WEST AFRICAN COMMERCE - Farouk Gumel</a></h4>
                            <div class="btn-box"><a href="#" data-toggle="modal" data-target="#modal-switch" class="read-more download-btn" data-type="download" data-presentation-url="assets/resources/day1keynote.pdf" data-image="/public/images/resource/day1Keynote.png">
                                Download Presentation</a></div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
                            ...
                            <div class="modal-body row g-0">
                                ...
                                <div class="col-md-7 p-4">
                                    ...
                                    <form action="{{ route('resources.lead') }}" method="POST" id="leadForm1" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <button class="btn btn-dark w-100 fw-bold py-2" id="recaptcha-button-lead" type="submit" data-type="Presentation"
                                            ...
                                            data-source="Day 1 Keynote"
                                            data-image="{{ asset('images/resource/day1Keynote.png') }}">

...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <a href="{{ route('blog.create') }}" class="btn btn-warning font-weight-bolder font-size-sm mr-3">
                            ...
                            <table id="example" class="table table-separate table-head-custom table-checkable" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('blog.edit', $blog->id) }}" class="btn btn-warning font-weight-bolder font-size-sm mr-3">

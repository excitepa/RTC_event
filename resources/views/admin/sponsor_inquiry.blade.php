...
@section("page_title", "Potential Sponsors")
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar">
                                <!--begin::Dropdown-->
                                <a href="{{ route('export.sponsor') }}" class="btn btn-warning font-weight-bolder font-size-sm mr-3">
                                    <i class="ki-duotone ki-add-folder"></i> Potential Sponsors
                                </a>
                            ...
                            <table class="table table-separate table-head-custom table-checkable" id="">
                                ...
                                <tbody>
                                    @php
                                        $cnt = 1;
                                    @endphp
                                    @foreach($sponsor_inquiries as $sponsor_inquiry)
                                    <tr>
                                        <td>
                                            {{ $cnt++ }}
                                        </td>

...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <ul>
                <li><strong>Session Title:</strong> Leading with Trust in Emerging Markets - Building Future-Ready Route-to-Market Teams for Sustainable Growth</li>
                <li><strong>Format:</strong> Fireside Chat</li>
                <li><strong>Event:</strong> RTM Conference 2025</li>
                <li><strong>Theme:</strong> Future-Proofing Route-to-Market Strategies in Emerging Markets</li>
            </ul>
            ...
            <div class="cta">
                <a href="https://www.youtube.com/embed/FMEskzdtC9g?si=l-2RbxPtDVibEMQ-" target="_blank">

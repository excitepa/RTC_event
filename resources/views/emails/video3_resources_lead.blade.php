    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <ul>
                ...
                <li> <strong>Day 1, Panel Session 3</strong></li>
            ...
            <ul>
                <li>Emeka Nwodo – Category Manager, Gum & Jellies at Perfetti Van Melle</li>
                <li>Segun Ogunleye – Head of Marketing at Diageo</li>
                <li>Maureen Ifada – Marketing Director at FC WAMCO</li>
                {{-- <li>Narendra Nagarkar – Chief Executive Officer, Bhojsons Group Plc</li> --}}
            </ul>
            <p><strong>Moderated by:</strong> Tola Bamigbaiye-Elatuyi – Chair, Brand Advisory Board at Meristem</p>

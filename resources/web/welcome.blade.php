...
@section("page_title", "Building a Consumer-Centric Route-to-Market. Harnessing Insights and Technology for success.")
@section("keywords", "route to market west africa, consumer-centric marketing, fmcg distribution, retail strategy nigeria, west africa consumer insights, market access technology, sales & distribution conference, rtm summit 2025, lagos business event, retail innovation west africa.")
@section("description", "Route to Market West Africa 2025, a premier event bringing together industry leaders, innovators, and key stakeholders in retail, distribution, and trade across West Africa. This year’s event, themed “Building a Consumer- Centric Route-to-Market”, will feature expert-led panels, keynote sessions, product showcases, and networking opportunities, focusing on topics such as consumer behavior, macroeconomic trends, digital transformation, data-driven decision-making, sales strategy, analytics in retail, e-commerce in Africa, and mobile technology for market access.")
...
<section class="banner-conference">
    ...
    <div class="auto-container">
        ...
        <div class="content-box" style="margin-top: -4rem">
            ...
            <h4 style="margin-top: -3rem">Harnessing Insights and Technology for success.</h4>
        ...
        <div class="row">
            ...
            <div class="feature-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                ...
                <div class="inner-box" style="height: 24rem">
                    ...
                    <h4><a href="about.html">Engaging keynote speakers and panel discussions</a></h4>
            ...
            <div class="feature-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="400ms">
                ...
                <div class="inner-box" style="height: 24rem">
                    ...
                    <h4><a href="about.html">Panel discussions</a></h4>
            ...
            <div class="feature-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="800ms">
                ...
                <div class="inner-box" style="height: 24rem">
                    ...
                    <h4><a href="about.html">Product Presentation</a></h4>
        ...
        <div class="row">
            ...
            <div class="feature-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                ...
                <div class="inner-box" style="height: 24rem">
                    ...
                    <h4><a href="about.html">Interactive Question and Answers</a></h4>
            ...
            <div class="feature-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="400ms">
                ...
                <div class="inner-box" style="height: 24rem">
                    ...
                    <h4><a href="about.html">Social media engagement</a></h4>
            ...
            <div class="feature-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="800ms">
                ...
                <div class="inner-box" style="height: 24rem">
                    ...
                    <h4><a href="about.html">Networking Lunch and Exhibitors Showcase</a></h4>
...
<section class="fun-fact-section style-two" style="background-image: url(imagesund/9.jpg);">
    ...
    <div class="auto-container">
        ...
        <div class="fact-counter">
            ...
            <div class="row clearfix">
                ...
                <div class="counter-column col-lg-3 col-md-6 col-sm-12 wnUp" data-wow-delay="1200ms">
                        ...
                        <div class="schedule-block">
                            ...
                            <div class="inner-box">
                                ...
                                <div class="inner">
                                    ...
                                    <h4><a href="{{ route('event.detail2ata-Driven Decision Making: Leveraging Analytics to Enhance Route-to-Consumer Effectiveness</a></h4>
                        ...
                        <div class="schedule-block">
                            ...
                            <div class="inner-box">
                                ...
                                <div class="inner">
                                    ...
                                    <div class="date">11.00 AM - 12.00 A
                        ...
                        <div class="schedule-block">
                            ...
                            <div class="inner-box">
                                ...
                                <div class="inner">
                                    ...
                                    <h4><a href=etail.html">Modern Marketing Summit Sydney 2018</a></h4>
                            ...
                            <div class="inner-box">
                                ...
                                <div class="inner">
                                    ...
                                    <div class="speaker-info">
                                        ...
                                        <span class="designation">FoCEO</span>
                                    ...
                                    <div class="btn-box">
                                        ...
                                        <a href="event-detail.html" heme-btn">Read More</a>
                            ...
                            <div class="inner-box">
                                ...
                                <div class="inner">
                                    ...
                                    <div class="btn-box">
                                        ...
                                        <a href="eventhtml" class="theme-btn">Read More</a>
